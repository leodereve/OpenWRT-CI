...
# 推薦使用 jerrykuku 的版本，兼容性最強，功能最全
UPDATE_PACKAGE "argon" "jerrykuku/luci-theme-argon" "master"
UPDATE_PACKAGE "argon-config" "jerrykuku/luci-app-argon-config" "master"
#被替换的
#UPDATE_PACKAGE #UPDATE_PACKAGE "aurora" "eamonxg/luci-theme-
#UPDATE_PACKAGE #UPDATE_PACKAGE "aurora-config" "eamonxg/luci-app-aurora-
